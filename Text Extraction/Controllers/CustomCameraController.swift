...
class CustomCameraController: UIViewController, AVCapturePhotoCaptureDelegate {
    ...
    @objc private func handleTakePhoto() {
        ...
        onSavePhoto = { imagetext in
            ...
            nextViewController.texttoimage = imagetext
    ...
    func photoOutput(_ output: AVCapturePhotoOutput, didFinishProcessingPhoto photo: AVCapturePhoto, error: Error?) {
        ...
        guard let cgImage = previewImage?.cgImage else {return}
        ...
        let request = VNRecognizeTextRequest { [self] request, error in
            guard let observations = request.results as? [VNRecognizedTextObservation],
             ...
             print("OCR TEXT FRoM IMAGE______ \(text)") // text we get from image
